<?php
    ...
    $new_product_query_result = $obj_app->select_published_new_product_info();
                            ...
                            <li class="yamm-content">
                                <div class="row">
                                    ...
                                    <div class="dropdown-banner-holder">
                                        <a href="#"><img alt="" src="assets/fornt_end/images/banners/banner-side.png" /></a>
                                    </div>
                                </div><!-- /.row -->
                            </li><!-- /.yamm-content -->                    
                        </ul><!-- /.dropdown-menu -->
                                    ...
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/sm1.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/sm1.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/sm2.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/sm2.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/sm3.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/sm3.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/sm4.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/sm4.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                                <div class="tag tag-micro hot">
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/sm5.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/sm5.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/sm6.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/sm6.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
        ...
        <div id="hero">
            <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                ...
                <div class="item" style="background-image: url(assets/fornt_end/images/sliders/01.jpg);">
                    <div class="container-fluid">
                ...
                <div class="tab-pane in active" id="all">			
                    <div class="product-slider">
                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4"> 
                            ...
                            <?php while($new_product = mysqli_fetch_assoc($new_product_query_result )):?>
                            <div class="item item-carousel">
                                <div class="products">
                                    ...
                                    <div class="product">		
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_details.php?ID=<?php echo $new_product['product_id']; ?>"><img  src="nullfolder/<?php  echo $new_product['product_image']; ?>" data-echo="nullfolder/<?php  echo $new_product['product_image']; ?>" height="200" width="200" alt=""></a>
                                            </div><!-- /.image -->			
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name"><a href="product_details.php?ID=<?php echo $new_product['product_id']; ?>"><?php echo $new_product['product_name']; ?></a></h3>
                                            <div class="rating rateit-small"></div>
                                            <div class="description"></div>

                                            <div class="product-price">	
                                                <span class="price">BDT <?php echo $new_product['product_price']; ?></span>
                                            ...
                                            <div class="action">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="lnk wishlist">
                                                        <a class="add-to-cart" href="product_details.php?ID=<?php echo $new_product['product_id']; ?>" title="Wishlist">
                                                            <i class="icon fa fa-heart"></i>
                                                        </a>
                                                    </li>

                                                    <li class="lnk">
                                                        <a class="add-to-cart" href="product_details.php?ID=<?php echo $new_product['product_id']; ?>" title="Compare">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="wide-banner cnt-strip">
                        <div class="image">
                            <img class="img-responsive" data-echo="assets/fornt_end/images/banners/1.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                        </div>	
                        <div class="strip">
                ...
                <div class="col-md-5">
                    <div class="wide-banner cnt-strip">
                        <div class="image">
                            <img class="img-responsive" data-echo="assets/fornt_end/images/banners/2.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                        </div>	
                        <div class="strip">
                            <div class="strip-inner">
        ...
        <div class="wide-banners wow fadeInUp outer-bottom-vs">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="wide-banner cnt-strip">
                        <div class="image">
                            <img class="img-responsive" data-echo="assets/fornt_end/images/banners/3.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                        </div>	
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/s1.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/s1.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/s2.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/s2.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                ...
                                <div class="product-micro">
                                    <div class="row product-micro-row">
                                        <div class="col col-xs-5">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="assets/fornt_end/images/products/s3.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
                                                        <img data-echo="assets/fornt_end/images/products/s3.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                        <div class="zoom-overlay"></div>
                                                    </a>					
                                                </div><!-- /.image -->
                                                <div class="tag tag-micro hot">
                ...
                <div class="owl-carousel blog-slider custom-carousel">
                    ...
                    <div class="item">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <div class="image">
                                    <a href="indexf6f2.html?page=blog"><img data-echo="assets/fornt_end/images/blog-post/1.jpg" width="270" height="135" src="assets/fornt_end/images/blank.gif" alt=""></a>
                                </div>
                            </div><!-- /.blog-post-image -->
                    ...
                    <div class="item">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <div class="image">
                                    <a href="indexf6f2.html?page=blog"><img data-echo="assets/fornt_end/images/blog-post/2.jpg" width="270" height="135" src="assets/fornt_end/images/blank.gif" alt=""></a>
                                </div>
                            </div><!-- /.blog-post-image -->
                    ...
                    <div class="item">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <div class="image">
                                    <a href="indexf6f2.html?page=blog"><img data-echo="assets/fornt_end/images/blog-post/3.jpg" width="270" height="135" src="assets/fornt_end/images/blank.gif" alt=""></a>
                                </div>
                            </div><!-- /.blog-post-image -->
                    ...
                    <div class="item">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <div class="image">
                                    <a href="indexf6f2.html?page=blog"><img data-echo="assets/fornt_end/images/blog-post/4.jpg" width="270" height="135" src="assets/fornt_end/images/blank.gif" alt=""></a>
                                </div>
                            </div><!-- /.blog-post-image -->
                    ...
                    <div class="item">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <div class="image">
                                    <a href="indexf6f2.html?page=blog"><img data-echo="assets/fornt_end/images/blog-post/5.jpg" width="270" height="135" src="assets/fornt_end/images/blank.gif" alt=""></a>
                                </div>
                            </div><!-- /.blog-post-image -->
                    ...
                    <div class="item">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <div class="image">
                                    <a href="indexf6f2.html?page=blog"><img data-echo="assets/fornt_end/images/blog-post/6.jpg" width="270" height="135" src="assets/fornt_end/images/blank.gif" alt=""></a>
                                </div>
                            </div><!-- /.blog-post-image -->
