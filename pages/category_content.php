...
$select_category_product = $obj_app->select_published_product_category_by_id($category_id);
...
<div class='row outer-bottom-sm'>
    ...
    <div class='col-md-9'>
        ...
        <div id="category" class="category-carousel hidden-xs">
            <div class="item">	
                <div class="image">
                    <img src="assets/fornt_end/images/banners/cat-banner-1.jpg" alt="" class="img-responsive">
                </div>
                <div class="container-fluid">
                    <div class="caption vertical-top text-left">
                        <div class="big-text">
                ...
                <div class="tab-pane active " id="grid-container">
                    <div class="category-product  inner-top-vs">
                        <div class="row">									
                            ...
                            <?php while ($category_product = mysqli_fetch_assoc($select_category_product)):?>
                                ...
                                <div class="products">
                                    ...
                                    <div class="product">		
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="product_details.php?ID=<?php echo $category_product['product_id']; ?>"><img  src="nullfolder/<?php echo $category_product['product_image']; ?>" data-echo="nullfolder/<?php echo $category_product['product_image']; ?>" height="200" width="200" alt=""></a>
                                            </div><!-- /.image -->			
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name"><a href="product_details.php?ID=<?php echo $category_product['product_id']; ?>"><?php echo $category_product['product_name']; ?></a></h3>
                                            <div class="rating rateit-small"></div>
                                            <div class="description"></div>

                                            <div class="product-price">	
                                                <span class="price">
                                                  BDT <?php echo $category_product['product_price']; ?></span>
                                ...
                                <div class="product-list product">
                                    <div class="row product-list-row">
                                        <div class="col col-sm-4 col-lg-4">
                                            <div class="product-image">
                                                <div class="image">
                                                    <img data-echo="assets/fornt_end/images/products/c1.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                </div>
                                            </div><!-- /.product-image -->
                                        </div><!-- /.col -->
                                        <div class="col col-sm-8 col-lg-8">
                                            <div class="product-info">
                                                <h3 class="name"><a href="indexbd17.html?page=detail">Simple Products Demo Showcase</a></h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="product-price">	
                                                    <span class="price">
                                                        $650.99					</span>
                                ...
                                <div class="product-list product">
                                    <div class="row product-list-row">
                                        <div class="col col-sm-4 col-lg-4">
                                            <div class="product-image">
                                                <div class="image">
                                                    <img data-echo="assets/fornt_end/images/products/c2.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                </div>
                                            </div><!-- /.product-image -->
                                        </div><!-- /.col -->
                                        <div class="col col-sm-8 col-lg-8">
                                ...
                                <div class="product-list product">
                                    <div class="row product-list-row">
                                        <div class="col col-sm-4 col-lg-4">
                                            <div class="product-image">
                                                <div class="image">
                                                    <img data-echo="assets/fornt_end/images/products/c3.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                </div>
                                            </div><!-- /.product-image -->
                                        </div><!-- /.col -->
                                        <div class="col col-sm-8 col-lg-8">
                                ...
                                <div class="product-list product">
                                    <div class="row product-list-row">
                                        <div class="col col-sm-4 col-lg-4">
                                            <div class="product-image">
                                                <div class="image">
                                                    <img data-echo="assets/fornt_end/images/products/c4.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                </div>
                                            </div><!-- /.product-image -->
                                        </div><!-- /.col -->
                                        <div class="col col-sm-8 col-lg-8">
                                            <div class="product-info">
                                                <h3 class="name"><a href="indexbd17.html?page=detail">Nokia</a></h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="product-price">	
                                                    <span class="price">
                                                        $650.99					</span>
                                ...
                                <div class="product-list product">
                                    <div class="row product-list-row">
                                        <div class="col col-sm-4 col-lg-4">
                                            <div class="product-image">
                                                <div class="image">
                                                    <img data-echo="assets/fornt_end/images/products/c5.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                </div>
                                            </div><!-- /.product-image -->
                                        </div><!-- /.col -->
                                        <div class="col col-sm-8 col-lg-8">
                                ...
                                <div class="product-list product">
                                    <div class="row product-list-row">
                                        <div class="col col-sm-4 col-lg-4">
                                            <div class="product-image">
                                                <div class="image">
                                                    <img data-echo="assets/fornt_end/images/products/c6.jpg" src="assets/fornt_end/images/blank.gif" alt="">
                                                </div>
                                            </div><!-- /.product-image -->
                                        </div><!-- /.col -->
                                        <div class="col col-sm-8 col-lg-8">
