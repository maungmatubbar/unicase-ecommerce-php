                    ...
                    <div class="contact-info">
                        ...
                        <div class="module-body m-t-20">
                            ...
                            <div class="social-icons">
                                ...
                                <a href="https://facebook.com/transvelo" class='active'><i class="icon fa fa-facebook"></i></a>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-padding">
                <div class="clearfix payment-methods">
                    <ul>
                        <li><img src="assets/fornt_end/images/payments/1.png" alt=""></li>
                        <li><img src="assets/fornt_end/images/payments/2.png" alt=""></li>
                        <li><img src="assets/fornt_end/images/payments/3.png" alt=""></li>
                        <li><img src="assets/fornt_end/images/payments/4.png" alt=""></li>
                        <li><img src="assets/fornt_end/images/payments/5.png" alt=""></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div>
